        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo current_url(); ?>">Orders</a></li>
            ...
            <tbody>
                ...
                ?>
                  <tr>
                      ...
                      <td><span class="rupee-sumbol-sm"><i class="fas fa-rupee-sign"></i></span> <?= $payment_data[$i-1]['payble_amt']; ?> </td>
                      <td>
